...
<body>
	...
	<form>
		...
		<button type="submit" formaction="./modifyOracle" formmethod="get">수정</button>
		<button type="submit" formaction="./deleteOracle" formmethod="post">삭제</button>	
	</form>
	<a href="./oracle"><button type="submit">목록</button></a>
</body>
</html>